...
public class CalendarAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if ((Integer.parseInt(gridvalue) > 1) && (position < firstDay)) {
            ...
            dayView.setTextColor(Color.GRAY);//WHITE
            ...
            dayView.setTextColor(v.getResources().getColor(R.color.black));
        }

		/*if (dayString.get(position).equals(curentDateString)) {
			setSelected(v);
			previousView = v;
			dayView.setTextColor(v.getResources().getColor(R.color.current_date_txt_color));
		} else {
...
//		dayView.setText(gridvalue);
        ...
        if (date.length() > 0 && items != null && items.contains(date)) {
            ...
            v.setBackgroundResource(R.drawable.dot1);//for show dot date bg
//			dayView.setTextColor(v.getResources().getColor(R.color.dot_date_txt_color));
        } else {
...
//			dayView.setTextColor(v.getResources().getColor(R.color.black));
    ...
    public View setSelected(View view) {
        ...
        previousView = view;
        view.setBackgroundResource(R.drawable.ic_square);
        return view;
    }
