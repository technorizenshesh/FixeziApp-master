...
public class RadialPickerLayout extends FrameLayout implements OnTouchListener {
    ...
    private static final int HOUR_INDEX = TimePickerDialogSet.HOUR_INDEX;
    private static final int MINUTE_INDEX = TimePickerDialogSet.MINUTE_INDEX;
    private static final int SECOND_INDEX = TimePickerDialogSet.SECOND_INDEX;
    private static final int AM = TimePickerDialogSet.AM;
    private static final int PM = TimePickerDialogSet.PM;
     ...
     * @param is24HourMode
     */
    public void initialize(Context context, TimePickerDialogSet timePickerDialog,
