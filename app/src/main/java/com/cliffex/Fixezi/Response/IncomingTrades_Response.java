...
public class IncomingTrades_Response {
    @SerializedName("id")
    @Expose
    private String id;
    ...
    @Expose
    private Rating_Income rating;
    @SerializedName("exp_status")
    @Expose
    private String expStatus;
    @SerializedName("problem")
    @Expose
    private List<Problem_Income> problem = null;
    ...
    public Rating_Income getRating() {
        return rating;
    }

    public void setRating(Rating_Income rating) {
        this.rating = rating;
    }
    ...
    public List<Problem_Income> getProblem() {
        return problem;
    }

    public void setProblem(List<Problem_Income> problem) {
