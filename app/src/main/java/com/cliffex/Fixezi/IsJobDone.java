...
public class IsJobDone extends AppCompatActivity {


    Toolbar toolbar;
    TextView toolbar_textview, ProblemDetail, DateDetail, TimeDetail, FlexibleDateDetail, FlexibleTimeDetail, PersonOnSiteDetail, JobAddressDetail;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar_textview.setText("Is Job Done");
        ...
        if (InternetDetect.isConnected(this)) {
            ...
            Toast.makeText(IsJobDone.this, "Please Connect to Internet", Toast.LENGTH_SHORT).show();
        }
            ...
            if (result == null) {
                ...
                IsJobDoneTV.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        final String[] strings = {"Completed", "Ordered parts", "Job has been Quoted", "Need to return", "Need to quote", "Job Cancelled"};

                        new AlertDialog.Builder(IsJobDone.this)
                                .setTitle("Select One")
                                            ...
                                            new AlertDialog.Builder(IsJobDone.this)
                                                    ...
                                                    .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                                        public void onClick(final DialogInterface dialog, int whichButton) {
                                                            ...
                                                            if (InternetDetect.isConnected(IsJobDone.this)) {
