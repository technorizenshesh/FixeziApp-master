...
public class GooglePlacesAutocompleteActivityUpdate extends Activity {
        ...
        try {
            if (count == 0) {
                ...
                if (s == null) {
                    ...
                    GeoAutoCompleteAdapter ga = new GeoAutoCompleteAdapter(GooglePlacesAutocompleteActivityUpdate.this, l1, "" + latitude, "" + longitude);
                ...
                geo_search_result_text.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (l2 == null || l2.isEmpty()) {
                            ...
                            PreferenceConnector.writeString(GooglePlacesAutocompleteActivityUpdate.this, PreferenceConnector.Address_Save1, order_landmarkadd);

                            finish();
/*
                            Intent in = new Intent(GooglePlacesAutocompleteActivity.this,UserActivity.class);
                            in.putExtra("search_address",order_landmarkadd);
                            startActivity(in);*/

                            /*  Toast.makeText(getApplicationContext(),order_landmarkadd,Toast.LENGTH_SHORT).show();*/
